...
const Navbar = ({ currentPage, setCurrentPage }) => {
    return (
        <div className="h-[10%] w-full flex px-3 max-md:justify-between top-0 left-0  bg-white shadow-md z-50  py-2">
            ...
            {
                currentPage == "Home" || currentPage == "About" || currentPage == "Courses"|| currentPage == "Contact" ?
                <>
                    ...
                    <div className="h-full w-[30%] flex items-center justify-end">
                        <button
                            className={`h-full w-1/3 max-md:w-2/3 bg-[#03989E] rounded-xl text-white font-semibold`}
                        >
                            SignIn
                        </button>
                    </div>
